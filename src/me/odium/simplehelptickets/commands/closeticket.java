...
public class closeticket implements CommandExecutor {   
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)  {    
    ...
    if(args.length == 0) {        
    	sender.sendMessage(plugin.replaceColorMacros(plugin.getOutputConfig().getString("UserCommandsMenu-closeticket") + plugin.getOutputConfig().getString("UserCommandsDescription-closeticket")));
    	return true;
      // CLOSING TICKET
